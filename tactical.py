...
if __name__ == "__main__":
    ...
    while not done:
        ...
        state = next_state
        score += reward
        tcvs.append(tcv.item())
        print("dist {}, reward {}, {}, vx {}, vy {}, tcv {}".format(round(state.goal_distance, 6), round(reward, 2), info, round(state.velocity[0], 2), round(state.velocity[1], 2), tcv.item()))
    ...
    env.multi_render(mode=args.render_mode, output_file="./figures/iqn_random_init", tcvs=tcvs)